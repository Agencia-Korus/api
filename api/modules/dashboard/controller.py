...
@router.get(
	...
	description=(
		'Admin pode consultar qualquer cliente. Cliente consulta apenas o próprio painel.'
	),
...
@router.get(
	...
	description=(
		'Admin pode consultar qualquer funcionário. Funcionário consulta apenas o próprio painel.'
	),
...
async def funcionario(
	...
	return await servico.funcionario(funcionario_id, usuario_atual.id, usuario_atual.papel)
...
async def projeto_kanban(
	...
	return await servico.projeto_kanban(projeto_id, usuario_atual.id, usuario_atual.papel)
